...
#include "displayapp/screens/WatchFaceRedminal.h"
    ...
    screen {[this, &settingsController]() {
      switch (settingsController.GetClockFace()) {
        ...
        case 5:
          ...
          break;
        case 6:
          return WatchFaceRedminalScreen();
          break;
      }
      return WatchFaceDigitalScreen();
    }()} {
...
std::unique_ptr<Screen> Clock::WatchFaceRedminalScreen() {
  return std::make_unique<Screens::WatchFaceRedminal>(dateTimeController,
                                                      batteryController,
                                                      bleController,
                                                      notificationManager,
                                                      settingsController,
